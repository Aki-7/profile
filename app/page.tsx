...
const Twitter = ({ href, accountName }: { href: string, accountName: string }) => <Anchor href={href} className="text-lg">
  <Image src={twitterIcon} alt="twitter" className="w-5 inline mr-2 align-text-middle" />{accountName}
</Anchor>;

const GitHub = ({ href, accountName }: { href: string, accountName: string }) => <Anchor href={href} className="text-lg">
  <Image src={githubIcon} alt="github" className="w-5 inline mr-2 mb-1" />{accountName}
</Anchor>;

const CV = () => <Anchor href="https://github.com/Aki-7/Aki-7/blob/main/CV.adoc" className="text-lg">
  <Image src={cvIcon} alt="github" className="w-5 inline mr-2 mb-1" />CV
</Anchor>;
      ...
      <div className="container mx-auto bg-red-050 py-12 px-4 sm:px-10">
        <div className="grid grid-cols-12 gap-8 text-sm lg:text-base">
          ...
          <div className="col-start-1 col-span-12 mt-4 lg:col-span-7 lg:mt-0">
            ...
            <div className="mt-4 text-left">
              ...
              lead to an inclusive market where developers of all sizes can participate in mixed reality development.
                `}
              {/* As for research, I am exploring new application paradigms in a mixed reality to enable users and society to maximize the power of mixed reality. */}
            </div>
          </div>
          ...
          <ProjectItem title="Zwin: XR Windowing System" image={zwinImage} link="https://www.zwin.dev">
            ...
            <div className="mt-4">
              Talks: <Anchor href="https://youtu.be/g_MvbwKp8Uk">MITOU'21</Anchor> (Japanese), <Anchor href="https://youtu.be/yS6kJgclavs">MITOU Advanced'22</Anchor> (Japanese).
            </div>
          </ProjectItem>

          <div className="col-start-3 col-span-8"><hr /></div>

          <ProjectItem title="Jenkins Remoting Monitoring (Google Summer of Code'21)" image={jenkinsImage} link="https://www.jenkins.io/projects/gsoc/2021/projects/remoting-monitoring/">
            <div className="mt-3 lg:mt-2">
              <div className="text-center lg:inline-block lg:mr-5">
                <GitHub href="https://github.com/jenkinsci/remoting-opentelemetry-plugin" accountName="remoting-opentelemetry-plugin" />
              </div>
            </div>
            <div className="mt-4">
            ...
            <div className="mt-4">
              Talks: <Anchor href="https://www.cloudbees.com/videos/jenkins-remoting-monitoring-with-opentelemetry">DevOpsWorld'21</Anchor>, <Anchor href="https://cloudbees.techmatrix.jp/jenkins-day-japan2021">Jenkins Day Japan</Anchor> (No public archive).
            </div>
          </ProjectItem>
